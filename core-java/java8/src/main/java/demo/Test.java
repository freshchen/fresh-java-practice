...
//
//
//        OffsetDateTime currentDay = OffsetDateTime.now().truncatedTo(ChronoUnit.DAYS);
//        OffsetDateTime currentMonth = currentDay.minusDays(currentDay.getDayOfMonth() - 1);
//        OffsetDateTime with = OffsetDateTime.now().truncatedTo(ChronoUnit.DAYS).with(TemporalAdjusters.firstDayOfMonth());
//
//        System.out.println(currentDay);
//        System.out.println(currentMonth);
//        System.out.println(with);

//        BigDecimal amount = new BigDecimal("12345671111111111111111111111111119").divide(new BigDecimal("1"), RoundingMode.HALF_UP);
//        System.out.println(amount);
